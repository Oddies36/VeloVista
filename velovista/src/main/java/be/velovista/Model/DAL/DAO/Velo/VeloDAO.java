...
public class VeloDAO implements IVeloDAO {
    ...
    /**
     * Cherche le prix des vélos classiques (ils ont tous le même prix)
    ...
    /**
     * Cherche le prix des vélos éléctriques (ils ont tous le même prix)
     * @return Retourne le prix
     */
    ...
    /**
     * Cherche le prix des vélos pour enfants (ils ont tous le même prix)
     * @return Retourne le prix
     */
    ...
    /**
     * Cherche la liste des vélos classiques
     * @return Retourne une ArrayList<Velo> avec tout les vélos classiques
     */
    public ArrayList<Velo> getListeVeloClass() {
        ...
        try (PreparedStatement pstat = DBConnection.conn.prepareStatement(sqlString)) {
            ResultSet rset = pstat.executeQuery();
            while (rset.next()) {
                vc = new VeloClassique(rset.getInt(10), rset.getInt(1), rset.getString(2), rset.getString(5),
                        rset.getString(3), rset.getBoolean(7), rset.getString(12), rset.getInt(6), rset.getInt(4),
                        rset.getDouble(8), rset.getString(9));
                result.add(vc);
            }
            return result;
        } catch (SQLException e) {
    ...
    /**
     * Cherche la liste des vélos éléctriques
     * @return Retourne une ArrayList<Velo> avec tout les vélos éléctriques
     */
    public ArrayList<Velo> getListeVeloElec() {
        ...
        try (PreparedStatement pstat = DBConnection.conn.prepareStatement(sqlString)) {
            ResultSet rset = pstat.executeQuery();
            while (rset.next()) {
                vc = new VeloElectrique(rset.getInt(11), rset.getInt(1), rset.getString(2), rset.getString(5),
                        rset.getString(3), rset.getBoolean(7), rset.getString(12), rset.getInt(6), rset.getInt(4),
                        rset.getDouble(8), rset.getString(9));
                result.add(vc);
            }
    ...
    /**
     * Cherche la liste des vélos pour enfants
     * @return Retourne une ArrayList<Velo> avec tout les vélos pour enfants
     */
    public ArrayList<Velo> getListeVeloEnfant() {
        ...
        try (PreparedStatement pstat = DBConnection.conn.prepareStatement(sqlString)) {
            ResultSet rset = pstat.executeQuery();
            while (rset.next()) {
                vc = new VeloEnfant(rset.getInt(1), rset.getString(2), rset.getString(5), rset.getString(3),
                        rset.getBoolean(7), rset.getString(12), rset.getInt(6), rset.getInt(4), rset.getDouble(8),
                        rset.getString(9));
                result.add(vc);
            }
            return result;
    ...
    /**
     * Cherche un vélo avec l'id. Crée un objet vélo différent dépendant du type
     * @param id L'ID du vélo
     * @return Retourne un objet velo
     */
    public Velo getVelo(int id) {
        ...
        try (PreparedStatement pstat = DBConnection.conn.prepareStatement(sqlString)) {
            ...
            while (rset.next()) {
                ...
                switch (type) {
                    case "Classique":
                        v = new VeloClassique(rset.getInt(10), rset.getInt(1), rset.getString(2), rset.getString(5),
                                rset.getString(3), rset.getBoolean(7), rset.getString(12), rset.getInt(6),
                                rset.getInt(4), rset.getDouble(8), rset.getString(9));
                        break;
                    case "Electrique":
                        v = new VeloElectrique(rset.getInt(11), rset.getInt(1), rset.getString(2), rset.getString(5),
                                rset.getString(3), rset.getBoolean(7), rset.getString(12), rset.getInt(6),
                                rset.getInt(4), rset.getDouble(8), rset.getString(9));
                        break;
                    case "Enfant":
                        v = new VeloEnfant(rset.getInt(1), rset.getString(2), rset.getString(5), rset.getString(3),
                                rset.getBoolean(7), rset.getString(12), rset.getInt(6), rset.getInt(4),
                                rset.getDouble(8), rset.getString(9));
                        break;
                }
            }
    ...
    /**
     * Met à jour le statut de la disponibilité en Disponible dans la base de données
    ...
    /**
     * Met à jour le statut de la disponibilité en Indisponible dans la base de données
     * @param idVelo L'ID du vélo
     */
    public void updateVeloToIndispo(int idVelo) {
        String sqlString = "UPDATE velo SET estdisponible = false WHERE idvelo = ?";
    ...
    /**
     * Vérifie s'il y a déjà des lignes dans la table vélo
     * @return Retourne le nombre de lignes trouvées
     */
    ...
    // Insert les données des vélos classiques
    ...
    // Insert les données des vélos éléctriques
    ...
    // Insert les données des vélos pour enfants
    ...
    /**
     * Cherche chaque vitesses existant
     * 
     * @return ArrayList<Integer>
     */
    // public ArrayList<Integer> getVitesses(){
    // String sqlString = "select distinct vitesse from velo where typevelo =
    // 'Classique';";
